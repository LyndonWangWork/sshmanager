...
<template>
  <div class="min-h-screen flex items-center justify-center bg-transparent relative overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-primary-400/30 to-accent-400/30 rounded-full blur-3xl animate-float"></div>
      <div class="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-secondary-400/20 to-primary-400/20 rounded-full blur-3xl animate-float" style="animation-delay: -3s;"></div>
    </div>
    ...
    <div class="max-w-md w-full space-y-8 p-8 relative z-10">
      ...
      <div class="text-center animate-fade-in">
        <div class="mx-auto w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-glow mb-6">
      ...
      <div class="card animate-slide-up" style="animation-delay: 0.2s">
        <div class="card-body">
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <!-- 安全提示 -->
            <div v-if="isSetupMode" class="bg-gradient-to-r from-warning-50 to-warning-100 border border-warning-200 rounded-xl p-5 animate-slide-down">
              <div class="flex">
            ...
            <!-- 错误信息 -->
            <div v-if="error" class="bg-gradient-to-r from-error-50 to-error-100 border border-error-200 text-error-700 rounded-xl p-4 animate-slide-down">
            ...
            <BaseButton 
              ...
              size="lg"
            >
              <span v-if="!authStore.isLoading">{{ isSetupMode ? $t('auth.setup.button') : $t('auth.login.button') }}</span>
