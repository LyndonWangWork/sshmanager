      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex items-center">
            ...
            <h1 class="text-xl font-semibold text-gray-900">生成SSH密钥</h1>
          </div>
        </div>
      </div>
    </nav>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <textarea 
                  ...
                  readonly
                  rows="3"
                  class="w-full text-xs font-mono bg-gray-50 border border-gray-300 rounded-md p-3 resize-none"
                ></textarea>
